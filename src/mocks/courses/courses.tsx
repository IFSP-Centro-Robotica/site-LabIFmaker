...
export const CourseMock: InterfaceCoursesMock[] = [
  {
    ...
    description: `O curso de Desenho 3D e Impressão 3D abrange práticas pedagógicas para professores relacionadas ao desenho e à impressão em três dimensões. 
