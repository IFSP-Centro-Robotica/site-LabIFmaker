...
export const styleTextStrong = "font-ubuntu font-bold text-xl text-zinc-700";
export const styledText =
  "pt-2 font-montserrat font-bold text-xl text-black text-justify";
export const styledLinks =
  "font-montserrat font-bold text-blue-700 text-black ";
      ...
      {equipament && (
        <>
          <div className="w-full flex items-center justify-center pt-4 pb-4 bg-zinc-100">
            <h1 className="font-ubuntu font-bold text-4xl text-zinc-500">
              {equipament.title}
            </h1>
          </div>
